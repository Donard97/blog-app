...
RSpec.describe "posts/index.html.erb", type: :feature do
  before(:each) do
    ...
    @user = User.new(name: "Donard", bio: "Full stack developer", email: "donardgolaj@gmail.com", password: "donard22021", photo: "https://eitrawmaterials.eu/wp-content/uploads/2016/09/person-icon.png", posts_counter: 1, confirmed_at: Time.now)
    @user.save
    5.times do
