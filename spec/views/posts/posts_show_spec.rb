...
RSpec.feature 'User Show', type: :feature do
  before(:each) do
    ...
    @post_one = Post.create(title: 'Post 1', text: 'Content 1', comments_counter: 5, likes_counter: 1, author_id: @first_user.id)
    @post_two = Post.create(title: 'Post 2', text: 'Content 2', comments_counter: 0, likes_counter: 0, author_id: @first_user.id)
    @post_three = Post.create(title: 'Post 3', text: 'Content 3', comments_counter: 0, likes_counter: 0, author_id: @first_user.id)
    @post_four = Post.create(title: 'Post 4', text: 'Content 4', comments_counter: 0, likes_counter: 0, author_id: @first_user.id)
